...
print('Parties by Gender(%)')
print((pd.crosstab(students_df['Gender'], students_df['Leaning'], normalize='index')*100).round(3))
print("-_"*40)
print('Parties by Region')
print(pd.crosstab(students_df['Region'], students_df['Leaning']))
print('Parties by Region(%)')
print((pd.crosstab(students_df['Region'], students_df['Leaning'], normalize='index')*100).round(3))
print("-_"*40)
print('Parties by Religion')
print(pd.crosstab(students_df['Religion'], students_df['Leaning']))
print('Parties by Religion(%)')
print((pd.crosstab(students_df['Religion'], students_df['Leaning'], normalize='index')*100).round(3))
print("-_"*40)
print('Parties by Race/Ethnicity')
print(pd.crosstab(students_df['Race/Ethnicity'], students_df['Leaning']))
print('Parties by Race/Ethnicity(%)')
print((pd.crosstab(students_df['Race/Ethnicity'], students_df['Leaning'], normalize='index')*100).round(3))
print("-_"*40)
print('Parties by Education')
print(pd.crosstab(students_df['Education'], students_df['Leaning']))
print('Parties by Education(%)')
print((pd.crosstab(students_df['Education'], students_df['Leaning'], normalize='index')*100).round(3))
print("-_"*40)
print('Parties by Marital Status')
print(pd.crosstab(students_df['Marital Status'], students_df['Leaning']))
print('Parties by Marital Status(%)')
print((pd.crosstab(students_df['Marital Status'], students_df['Leaning'], normalize='index')*100).round(3))
print("-_"*40)
print('Parties by Area type')
print(pd.crosstab(students_df['Area type'], students_df['Leaning']))
print('Parties by Area type(%)')
print((pd.crosstab(students_df['Area type'], students_df['Leaning'], normalize='index')*100).round(3))
print("-_"*40)
print("Vote Count")
print(students_df['Leaning'].value_counts()) 
print((students_df['Leaning'].value_counts(normalize=True)*100).round(3))
print("-_"*40)
